...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-black/10 dark:border-white/10 bg-white/90 dark:bg-black/70 backdrop-blur">
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 px-4 sm:px-6 lg:px-8 py-3">
        <div />

        <Link href="/" className="flex items-center gap-2 font-bold text-lg justify-self-center">
        ...
        <nav className="flex items-center gap-2 sm:gap-3 justify-self-end">
          <Link
            href="/"
